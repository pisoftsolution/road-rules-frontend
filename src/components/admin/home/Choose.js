...
function Choose() {
  ...
  const handleEditSubmit = (e) => {
    ...
    dispatch(editChoose(formData, editId)).then((res) => {
      console.log(res);
  ...
  const handleAddSubmit = (e) => {
    e.preventDefault();
    dispatch(addChoose(formData, choice)).then((res) => {
      console.log(res);
      setShouldCall(!shouldCall);
    });
  };
        ...
        <Modal.Body>
          <form onSubmit={handleEditSubmit}>
            <div className="form-group">
              ...
              <Button classpoint="sub" type="submit">
                Save
              </Button>
              <Button className="cancel" id="closeMT" onClick={handleClose}>
                Close
              </Button>
            </div>
          </form>
