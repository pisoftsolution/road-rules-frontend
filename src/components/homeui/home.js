                            ...
                            <div className="container">
                                <div className="row row-cols-1 row-cols-md-3 g-4">
                                    <div className="col">
                                        <div className="card h-100">
                                            <div className="card-body">
                                                ...
                                                <p id="mny">45$</p>
                                                <div>
                                                    <button type="button" className="btn btn-primary" id="first">
                                                        Book Now
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col">
                                        <div className="card h-100">
                                            <div className="card-body">
                                                ...
                                                <p id="mny">240$</p>
                                                <div>
                                                    <button type="button" className="btn btn-primary" id="second">
                                                        Book Now
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col">
                                        <div className="card h-100">
                                            <div className="card-body">
                                                ...
                                                <p id="mny">400$</p>
                                                <div>
                                                    <button type="button" className="btn" id="third">
                                                        Book Now
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div className="btncheckprices">
                                        <button type="button" className="btn btn-lg" id="fourth">
                                            Check 1All Prices
                                        </button>
                                    </div>
                                </div>
